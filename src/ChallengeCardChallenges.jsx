...
function ChallengeCardChallenges() {
    return (
        <motion.div
        ...
        >
            ...
            <h2 className="text-2xl font-bold self-start">Test your aim</h2>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam consequatur corporis expedita fuga hic
            </p>
            <div className="self-end flex gap-2">
                <div className="badge badge-primary text-md font-bold p-2">250 xp</div>
                <div className="badge badge-secondary text-md font-bold p-2">10 pt</div>
                <div className="badge badge-accent text-md font-bold p-2">HARD</div>
            </div>
        </motion.div>
    );
}
