...
function ChallengeCardChallenges({ id, title, xp, points, difficulty }) {
    return (
        <Link to={`/challenge/${id}`} className="h-96 w-[calc((100%-2rem)/3)] flex-shrink-0 ">
            <motion.div
                className="rounded-xl bg-base-100 flex flex-col items-center justify-center gap-6 p-8 shadow-2xl cursor-pointer"
                whileHover={{
                    scale: 1.05,
